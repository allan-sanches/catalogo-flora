import { whatsappLink, mensagemInteresse } from "@/lib/site";
...
export default function InterestButton({
  ...
  return (
    <a
      href={whatsappLink(mensagemInteresse(nome, tamanho))}
      target="_blank"
      rel="noopener noreferrer"
      className={`btn btn-success gap-2 text-success-content ${className}`}
    >
